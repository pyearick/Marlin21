 ...
 * For the Creality V4.2.2 / V4.2.7 boards (Ender-3 / Pro / V2),
 * the main serial port is USART1 on pins PA10/PA9.
 */
 ...
 * For Creality V4.x boards leave this set to 0 unless you have extra hardware.
 */
//#define SERIAL_PORT_2 -1
//#define BAUDRATE_2 250000   // Enable to override BAUDRATE

/**
 * Optional third serial port.
 * Leave disabled unless you explicitly need it.
 */
...
#define Z_MIN_PROBE_ENDSTOP_HIT_STATE HIGH   // BLTouch is NO → HIGH when triggered
...
/**
 * NOZZLE_TO_PROBE_OFFSET: Distance from nozzle to probe
 * X: -40mm means probe is 40mm to the LEFT of nozzle
 * Y: -12mm means probe is 12mm in FRONT of nozzle  
 * Z: -1.70mm is the trigger height offset (calibrate with M851 Z)
 * 
 * Important: With 400x400 bed and Z_SAFE_HOMING at center (200,200):
 *   - Nozzle will be at (200, 200)
 *   - Probe will be at (160, 188) which is safely within bounds
 *   - With PROBING_MARGIN=10, probe must stay between (10,10) and (390,390)
 */
#define NOZZLE_TO_PROBE_OFFSET { -40.00, -12.00, -1.70 }   // From your M851
...
// Note: RESTORE_LEVELING_AFTER_G28 already defined at line 1419
#define Z_MIN_PROBE_REPEATABILITY_TEST

// Big bed → wider probing grid.
// Keep a margin so the probe stays on the plate; adjust if needed.
#define GRID_MAX_POINTS_X 5            // 5x5 mesh is a good start
// Note: PROBING_MARGIN is already defined below (line 1643)

// Use the probe as Z-min (typical BLTouch wiring on V4.2.2)
// Note: Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN already defined at line 1373
...
// :[-1,1]
/**
 * Endstop inverting - REQUIRED for your NC switches
 * Defaults are false → we must override for X and Z
 */

/**
 * Endstop hit state - HIGH when triggered, LOW when open
 * Creality V4 board uses NC switches + hardware inversion → we want LOW at rest
 */
